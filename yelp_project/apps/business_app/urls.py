...
urlpatterns = [
    ...
    url(r'^admin$', views.admin, name="admin-page"), # Admin Console for removing businesses.
    ...
    url(r'^destroy_user/(?P<user_id>\d+)$', views.destroy_user), # Removes a user from the db
]